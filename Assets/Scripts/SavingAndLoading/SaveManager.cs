...
public static class SaveManager
{
    ...
    public static ProceduralWorldGenerator GenerationObject => _generationObject;

    public static List<Player> Players => _players;

    public static List<Enemy> Enemies => _enemies;

    public static bool Autosave => _autosave;

    public static float AutosaveTime => _autosaveTime;

    public static float TimeElapsed => _timeElapsed;
    ...
    private static List<PlayerSaveData> GetPlayerSaveData()
    {
        ...
        for (int i = 0; i < players.Count; i++)
        {
            ...
            Players.Add(((SaveablePlayer)players[i].SaveableObject).RoleHandler.Player);
        }
    ...
    {
        // Start the coroutine
        GameManager.Instance.StartCoroutine(DelayedLoadGame());
    }
    ...
    private static IEnumerator DelayedLoadGame()
    {
        ...
        _generationObject = GameManager.Instance.ProceduralWorldGenerator;
