...
namespace Twitch.Commands
{
    ...
    public static class RoleCommands
    {
        ...
        {
            return $"{player.TwitchUser.Username}, you are a level ({player.RoleHandler.PlayerRoleData.CurrentLevel}/{RoleManager.MaxRoleLevel}) {player.RoleHandler.CurrentRole}. Current Exp: ({player.RoleHandler.PlayerRoleData.CurrentExp}/{player.RoleHandler.PlayerRoleData.RequiredExp}).";
        }
        ...
        public static string ExperienceForRole(Player player, PlayerRole role)
        {
            ...
            {
                return $"{player.TwitchUser.Username}, you are a level ({data.CurrentLevel}/{RoleManager.MaxRoleLevel}) {data.Role}. Current Exp: ({data.CurrentExp}/{data.RequiredExp}).";
            }
