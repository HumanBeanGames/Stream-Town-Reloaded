...
Shader "Godrays_Shaders"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_EmissionStrength("Emission Strength", Float) = 1
		[ASEEnd]_AlphaStrength("AlphaStrength", Float) = 0.1
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			UNITY_INSTANCING_BUFFER_START(Godrays_Shaders)
				UNITY_DEFINE_INSTANCED_PROP(float, _EmissionStrength)
			UNITY_INSTANCING_BUFFER_END(Godrays_Shaders)
						 ...
						 ) : SV_Target
			{
				...
				float _EmissionStrength_Instance = UNITY_ACCESS_INSTANCED_PROP(Godrays_Shaders,_EmissionStrength);
				
				float3 Albedo = IN.ase_color.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( IN.ase_color * _EmissionStrength_Instance ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.5;
				float Occlusion = 1;
				float Alpha = ( IN.ase_color.a * _AlphaStrength );
...
/*ASEBEGIN
Version=18935
20;93;1920;983;1195.524;324.9845;1;True;False
Node;AmplifyShaderEditor.VertexColorNode;14;-695,51;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;15;-512,208;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;9;-512,128;Inherit;False;InstancedProperty;_EmissionStrength;Emission Strength;0;0;Create;True;0;0;0;False;0;False;1;0.06;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;16;-272,208;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-512,272;Inherit;False;Property;_AlphaStrength;AlphaStrength;1;0;Create;True;0;0;0;False;0;False;0.1;1.64;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-256,48;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-160,144;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;17;-528,16;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=588B6DF011705F770E8ECC58D5BC291BE72F3E5D