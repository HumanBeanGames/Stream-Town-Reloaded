...
Shader "BoundsVisualiser"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_boundsVisColor("Color", Color) = (0.4986152,1,0.2028302,1)
		[ASEEnd]_Alpha("Alpha", Range( 0 , 1)) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Albedo = _boundsVisColor.rgb;
...
/*ASEBEGIN
Version=18935
0;0;1920;1011;1144.224;199.0054;1;True;False
Node;AmplifyShaderEditor.ColorNode;1;-842,-75.5;Inherit;False;Property;_boundsVisColor;Color;0;0;Create;False;0;0;0;False;0;False;0.4986152,1,0.2028302,1;0.3970321,1,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;2;-510,382.5;Inherit;False;Property;_Alpha;Alpha;2;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=C1EEE58760C66931A2A8D09F74C8E71AD1FFCE2E